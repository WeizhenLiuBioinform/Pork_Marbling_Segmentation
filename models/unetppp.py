...
class UNet_3Plus(nn.Module):
    ...
    def __init__(self, in_channels=3, num_classes=2, feature_scale=4, is_deconv=True, is_batchnorm=True, **kwargs):
    ...
    def forward(self, inputs):
        #inputs = F.upsample(inputs, size=(2*inputs.size(2),2*inputs.size(3)), mode='bilinear')
        ## -------------Encoder-------------
